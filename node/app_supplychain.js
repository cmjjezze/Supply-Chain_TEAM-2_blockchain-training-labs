...
if (invoiceNumber)
{
  //TODO START send appropriate attributes to query Cars by owner Rich Query
    ar.push(invoiceNumber);
    request.fcn= 'queryInvoice'
   request.args = ar;
...
// if (req.method == "POST")
// {
//   request.fcn='queryInvoices';
//   invoices.push(invoiceNumber);
//   invoices.push(billedTo);
//   invoices.push(invoiceDate);
//   invoices.push(invoiceAmount);
//   invoices.push(itemDescription);
//   invoices.push(gr);
//   invoices.push(isPaid);
//   invoices.push(paidAmount);
//   invoices.push(repaid);
// }
